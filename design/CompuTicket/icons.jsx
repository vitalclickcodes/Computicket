...
const Wordmark = ({ size = 22 }) => (
  <div style={{display:'inline-flex', alignItems:'center', gap:10}}>
    ...
    <div style={{display:'flex', flexDirection:'column', lineHeight:0.95}}>
      <span style={{fontFamily:'var(--font-display)', fontSize: size, fontWeight:600, letterSpacing:'-0.04em'}}>
        Computicket<span style={{color:'var(--accent)'}}>.</span>
      </span>
      <span className="mono" style={{fontSize: 9, letterSpacing:'.22em', color:'var(--ink-3)', textTransform:'uppercase', marginTop:1}}>Nigeria</span>
    </div>
  </div>
);
